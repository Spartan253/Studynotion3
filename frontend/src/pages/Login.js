  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        {/* ================= LEFT FORM ================= */}
        <div className="bg-gray-800/70 backdrop-blur-md rounded-xl
                        p-5 sm:p-8 md:p-10
                        text-white shadow-xl w-full max-w-md mx-auto lg:max-w-none">
        ...
        <div className="hidden lg:flex justify-center">
          <img
            src={loginImg}
            alt="Login"
            className="w-[420px] max-w-full rounded-xl shadow-lg"
          />
        </div>
